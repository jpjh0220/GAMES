...
const allowed = new Set(['pause','resume','abandon_objective','clear_directive','force_bank','force_fishing']);
...
const directive=rest.join(' ').trim()||null;
const document={revision,command,directive,expiresAt:new Date(Date.now()+30*60*1000).toISOString(),updatedAt:new Date().toISOString()};
